...
#define CONFIG_VIDIO_OV5640
#if defined(CONFIG_VIDIO_OV5640)
...
#if defined(CONFIG_VIDIO_OV5640) || defined(CONFIG_VIDEO_TVP5150)
...
#endif
#ifdef CONFIG_VIDEO_FIMC
	printk(KERN_ERR "s3c_fimc0_set_platdata.\n");
